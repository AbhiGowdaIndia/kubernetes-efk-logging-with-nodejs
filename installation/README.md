...
```bash
eksctl create addon --cluster observability-cluster --name aws-ebs-csi-driver --version latest --service-account-role-arn $ARN --force
```
...
* 👉 Note: Please update the HTTP_Passwd field in the fluentbit-values.yml file with the password retrieved earlier in step 6: (i.e GsVzS2ENmHY3daQ9)"
